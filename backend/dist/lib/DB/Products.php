...
class Products extends Table
{
  ...
  private $basicFields = ["id", "sku", "name", "price", "type"];

  private $fieldsByCategory = [
    "DVD" => ["size"],
    "Furniture" => ["width", "height", "length"],
    "Book" => ["weight"]
  ];

  private function pruneProduct($product)
  {
  ...
  private function validateSKU($productMap)
  {
    $sku = $productMap["sku"];
  ...
  private function validateCategoryFields($productMap)
  {
